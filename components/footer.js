...
export default function Footer() {
  return (
    <footer className=" container mx-auto py-14 px-8 grid lg:grid-cols-3 justify-between gap-8 text-gray-50 ">
  <div className=' container  '>
    ...
    <div className='flex gap-6  mx-4 my-5'>
  ...
  <div className='lg:col-span-1 flex justify-between text-lg '>
    <div className='mx-4'>
      <h6 className='font-medium text-gray-400'>Solution</h6>
      <ul className='text-black mt-3 px-2'>
  ...
  <div className="container mx-auto flex justify-center  text-center ">
    <p className=' text-gray-400 '>Copyright@hdk-ak All rights reserved</p>
  </div>
